...
def Unet3_plus_modified(input_shape=(512, 512, 3), nclasses=1):
    ...
    h_5 = tf.keras.layers.Conv2D(filters=1024, kernel_size=3, padding="same", use_bias=False)(h_5)
    ...
    max_pixel = -tf.math.log((1/(cls_branch_max + tf.keras.backend.epsilon()) ) - 1)
    #####################################################################################
    ...
    h_4_ = tf.where(tf.nn.sigmoid(h_4_) >= 0.5, h_4_ + max_pixel, h_4_ - max_pixel)
    h1_PT_hd4 = tf.where(tf.nn.sigmoid(h1_PT_hd4) >= 0.5, h1_PT_hd4 + max_pixel, h1_PT_hd4 - max_pixel)
    ...
    h2_PT_hd4 = tf.where(tf.nn.sigmoid(h2_PT_hd4) >= 0.5, h2_PT_hd4 + max_pixel, h2_PT_hd4 - max_pixel)
    ...
    h3_PT_hd4 = tf.where(tf.nn.sigmoid(h3_PT_hd4) >= 0.5, h3_PT_hd4 + max_pixel, h3_PT_hd4 - max_pixel)
    ...
    hd5_UT_hd4 = tf.where(tf.nn.sigmoid(hd5_UT_hd4) >= 0.5, hd5_UT_hd4 + max_pixel, hd5_UT_hd4 - max_pixel)
    ...
    h_3_ = tf.where(tf.nn.sigmoid(h_3_) >= 0.5, h_3_ + max_pixel, h_3_ - max_pixel)
    h1_PT_hd3 = tf.where(tf.nn.sigmoid(h1_PT_hd3) >= 0.5, h1_PT_hd3 + max_pixel, h1_PT_hd3 - max_pixel)
    ...
    h2_PT_hd3 = tf.where(tf.nn.sigmoid(h2_PT_hd3) >= 0.5, h2_PT_hd3 + max_pixel, h2_PT_hd3 - max_pixel)
    ...
    hd4_UT_hd3 = tf.where(tf.nn.sigmoid(hd4_UT_hd3) >= 0.5, hd4_UT_hd3 + max_pixel, hd4_UT_hd3 - max_pixel)
    ...
    hd5_UT_hd3 = tf.where(tf.nn.sigmoid(hd5_UT_hd3) >= 0.5, hd5_UT_hd3 + max_pixel, hd5_UT_hd3 - max_pixel)
    ...
    h_2_ = tf.where(tf.nn.sigmoid(h_2_) >= 0.5, h_2_ + max_pixel, h_2_ - max_pixel)
    h1_PT_hd2 = tf.where(tf.nn.sigmoid(h1_PT_hd2) >= 0.5, h1_PT_hd2 + max_pixel, h1_PT_hd2 - max_pixel)
    ...
    hd3_UT_hd2 = tf.where(tf.nn.sigmoid(hd3_UT_hd2) >= 0.5, hd3_UT_hd2 + max_pixel, hd3_UT_hd2 - max_pixel)
    ...
    hd4_UT_hd2 = tf.where(tf.nn.sigmoid(hd4_UT_hd2) >= 0.5, hd4_UT_hd2 + max_pixel, hd4_UT_hd2 - max_pixel)
    ...
    hd5_UT_hd2 = tf.where(tf.nn.sigmoid(hd5_UT_hd2) >= 0.5, hd5_UT_hd2 + max_pixel, hd5_UT_hd2 - max_pixel)
    ...
    h_1_ = tf.where(tf.nn.sigmoid(h_1_) >= 0.5, h_1_ + max_pixel, h_1_ - max_pixel)
    hd2_UT_hd1 = tf.where(tf.nn.sigmoid(hd2_UT_hd1) >= 0.5, hd2_UT_hd1 + max_pixel, hd2_UT_hd1 - max_pixel)
    ...
    hd3_UT_hd1 = tf.where(tf.nn.sigmoid(hd3_UT_hd1) >= 0.5, hd3_UT_hd1 + max_pixel, hd3_UT_hd1 - max_pixel)
    ...
    hd4_UT_hd1 = tf.where(tf.nn.sigmoid(hd4_UT_hd1) >= 0.5, hd4_UT_hd1 + max_pixel, hd4_UT_hd1 - max_pixel)
    ...
    hd5_UT_hd1 = tf.where(tf.nn.sigmoid(hd5_UT_hd1) >= 0.5, hd5_UT_hd1 + max_pixel, hd5_UT_hd1 - max_pixel)

...
FLAGS = easydict.EasyDict({"img_size": 576,
    ...
    if FLAGS.train:
        ...
        for epoch in range(FLAGS.epochs):
            ...
            for step in range(tr_idx):
                ...
                patch_labels_1 = batch_labels[:, 0:288, 0:288, :]
                patch_labels_2 = batch_labels[:, 0:288, 288:, :]
                patch_labels_3 = batch_labels[:, 288:, 0:288, :]
                patch_labels_4 = batch_labels[:, 288:, 288:, :]

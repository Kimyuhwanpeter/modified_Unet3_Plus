...
def cal_loss(model, batch_images, batch_labels, object_buf):
    ...
    with tf.GradientTape() as tape:
        ...
        loss_3 = hybrid_loss(batch_labels, sub_3, object_buf[1]) * 0.125
    ...
    if FLAGS.train:
        ...
        for epoch in range(FLAGS.epochs):
            ...
            for step in range(tr_idx):
                ...
                if count % 100 == 0:
                    final, _, _, _, _, _ = run_model(model, batch_images, False)
                    for i in range(FLAGS.batch_size):
            ...
            for i in range(tr_idx):
                ...
                for j in range(FLAGS.batch_size):
                    ...
                    final, _, _, _, _, _ = run_model(model, batch_image, False)
